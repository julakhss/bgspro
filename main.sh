...
clear;clear;clear
echo -e "${BlueBee}╔════════════════════════════════════════════════╗${NC}"
echo -e "\033[96;1m         JULAK BANTUR PREMIUM                   \033[0m"
echo -e "${BlueBee}╚════════════════════════════════════════════════╝${NC}"
echo ""
...
clear
rm -f /usr/bin/user
username=$(curl https://github.com/cibut2d/reg/raw/refs/heads/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://github.com/cibut2d/reg/raw/refs/heads/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/cibut2d/reg/raw/refs/heads/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/julakhss/bgspro/refs/heads/main/"
NOOBZJSON="https://raw.githubusercontent.com/julakhss/bgspro/refs/heads/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/cibut2d/reg/refs/heads/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/cibut2d/reg/refs/heads/main/ip | grep $ipsaya | awk '{print $3}')
TIMEZONE=$(printf '%(%H:%M:%S)T')
TEXT="
<code>────────────────────</code>
<b>⚡AUTOSCRIPT PREMIUM BGSPRO⚡</b>
<code>────────────────────</code>
...
<code>────────────────────</code>
<b> ❖ JULAKSSH  TUNNELING ❖  </b>
<code>────────────────────</code>
<i>Automatic Notifications From Github</i>
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://t.me/rajaganjil93"}]]}' 
...
mkdir -p /etc/julak/files/vmess/ip
mkdir -p /etc/julak/files/vless/ip
mkdir -p /etc/julak/files/trojan/ip
mkdir -p /etc/julak/files/ssh/ip
...
wget https://github.com/julakhss/bgspro/raw/refs/heads/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -q -O /usr/local/julak/udp-mini "${REPO}Fls/udp-mini"
...
wget -O /etc/julak.txt "${REPO}Bnr/julak.txt"
...
wget -O /etc/websocket/ws.py "${REPO}Fls/ws.py" >/dev/null 2>&1
...
echo -e ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
echo -e "\e[96;1m            ----[ JULAKSSH TUNNELING ]----                 \e[0m"
echo -e "\e[94;1m╚═════════════════════════════════════════════════╝\e[0m"
echo ""
echo -e "\e[95;1m  Whatsapp : +6281250851741 \e[0m"
echo -e "\e[95;1m  Telegram : @rajaganjil93 \e[0m"
echo ""
echo -e "\e[94;1m╔═════════════════════════════════════════════════╗\e[0m"
